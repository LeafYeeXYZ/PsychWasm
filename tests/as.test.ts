...
assert.strictEqual(as.vari([1, 2, 3], false).toFixed(PERCISION), Number(2 / 3).toFixed(PERCISION))
assert.strictEqual(as.std([1, 2, 3], false).toFixed(PERCISION), Number(Math.sqrt(2 / 3)).toFixed(PERCISION))
assert.strictEqual(as.vari([1, 2, 3, 4, 5]).toFixed(PERCISION), Number(2.5).toFixed(PERCISION))
assert.strictEqual(as.std([1, 2, 3, 4, 5]).toFixed(PERCISION), Number(Math.sqrt(2.5)).toFixed(PERCISION))
